...
// Result Type
export interface CtwThreeKmResult {
  id: number;
  course_id: number;
  semester_id: number;
  program_id?: number;
  ...
  instructor?: User;
  creator?: User;
  achieved_marks?: CtwThreeKmResultMark[];
}

export interface CtwThreeKmResultCreateData {
  course_id: number;
  semester_id: number;
  program_id?: number;
  branch_id?: number;
...
// Result Mark Type
export interface CtwThreeKmResultMarkDetail {
  id: number;
...
export interface CtwThreeKmResultMark {
  id: number;
  ...
  // Relations
  result?: CtwThreeKmResult;
  cadet?: CadetProfile;
  instructor?: User;
  creator?: User;
  details?: CtwThreeKmResultMarkDetail[];
}
