...
// Estimated Mark Type
export interface CtwFiringAssessmentEstimatedMark {
  id: number;
  semester_id: number;
  exam_type_id: number;
...
export interface CtwFiringAssessmentEstimatedMarkCreateData {
  semester_id: number;
  exam_type_id: number;
...
// Result Type
export interface CtwFiringResult {
  id: number;
  course_id: number;
  semester_id: number;
  program_id?: number;
  ...
  instructor?: User;
  creator?: User;
  achieved_marks?: CtwFiringResultMark[];
}

export interface CtwFiringResultCreateData {
  course_id: number;
  semester_id: number;
  program_id?: number;
  branch_id?: number;
...
// Result Mark Type
export interface CtwFiringResultMark {
  id: number;
  ...
  // Relations
  written_result?: CtwFiringResult;
  cadet?: CadetProfile;
  instructor?: User;
  creator?: User;
}

export interface CtwFiringResultMarkCreateData {
  cadet_id: number;
  instructor_id: number;
  achieved_mark: number;
  is_active?: boolean;
