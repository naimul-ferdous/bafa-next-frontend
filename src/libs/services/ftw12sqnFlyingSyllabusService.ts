/**
 * FTW 12sqn Flying Syllabus Service
 * API calls for FTW 12sqn Flying Syllabus management
 */
...
export const ftw12sqnFlyingSyllabusService = {
...
export default ftw12sqnFlyingSyllabusService;
