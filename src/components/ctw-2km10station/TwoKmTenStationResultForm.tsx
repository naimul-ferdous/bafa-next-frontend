...
import type { Ctw2kmTenStationResult } from "@/libs/types/ctw2kmTenStation";

interface ResultFormProps {
  initialData?: Ctw2kmTenStationResult | null;
...
export default function TwoKmTenStationResultForm({ initialData, onSubmit, onCancel, loading, isEdit = false }: ResultFormProps) {
  const { user } = useAuth();
  ...
  useEffect(() => {
    ...
    const loadDropdownData = async () => {
      try {
        ...
        const options = await ctwCommonService.getTwoKmTenStationFormOptions(user.id);
        ...
        <div className="border border-gray-200 rounded-lg p-6">
          ...
          {!filtersSelected ? (
            ...
            <div className="text-center py-12 text-red-500">
              ...
              <p className="font-medium">You are not assigned to the 2KM 10 Station module for the selected course & semester.</p>
            </div>
          ) : cadetRows.length === 0 ? (
            <div className="text-center py-12 text-gray-500">
