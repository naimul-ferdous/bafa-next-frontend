...
interface CounselingTypeFormProps {
  initialData?: AtwAssessmentCounselingType | null;
  onSubmit: (data: AtwAssessmentCounselingTypeCreateData) => Promise<void>;
  onCancel: () => void;
  loading: boolean;
  isEdit?: boolean;
}
...
export default function CounselingTypeForm({ initialData, onSubmit, onCancel, loading, isEdit = false }: CounselingTypeFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submitData: AtwAssessmentCounselingTypeCreateData = {
