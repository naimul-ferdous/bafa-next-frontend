...
export default function FiringResultForm({ initialData, onSubmit, onCancel, loading, isEdit = false }: ResultFormProps) {
  ...
  // Load dropdown data + find firing module
  useEffect(() => {
  ...
  useEffect(() => {
    const loadCadets = async () => {
      ...
      try {
        ...
        // First check if instructor is assigned to this firing module
        ...
        <div className="border border-gray-200 rounded-lg p-6">
          ...
          {!filtersSelected ? (
            ...
            <div className="text-center py-12 text-red-500">
              ...
              <p className="font-medium">You are not assigned to the Firing module for the selected course & semester.</p>
