...
interface ResultFormProps {
  initialData?: CtwArmsDrillResult | null;
...
export default function ArmsDrillResultForm({ initialData, onSubmit, onCancel, loading, isEdit = false }: ResultFormProps) {
  const { user } = useAuth();
        ...
        <div className="border border-gray-200 rounded-lg p-6">
          ...
          {!filtersSelected ? (
            ...
            <div className="text-center py-12 text-red-500">
              ...
              <p className="font-medium">You are not assigned to the Arms Drill module for the selected course & semester.</p>
