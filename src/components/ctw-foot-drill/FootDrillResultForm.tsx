...
interface ResultFormProps {
  initialData?: CtwFootDrillResult | null;
...
export default function FootDrillResultForm({ initialData, onSubmit, onCancel, loading, isEdit = false }: ResultFormProps) {
  const { user } = useAuth();
  ...
  const [footDrillModuleId, setFootDrillModuleId] = useState<number>(0);
  const [footDrillModule, setFootDrillModule] = useState<any>(null);
        ...
        <div className="border border-gray-200 rounded-lg p-6">
          ...
          {!filtersSelected ? (
            ...
            <div className="text-center py-12 text-red-500">
              ...
              <p className="font-medium">You are not assigned to the Foot Drill module for the selected course & semester.</p>
