...
interface CtwApprovalAuthorityModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
  authority: CtwResultApprovalAuthority | null;
}

export default function CtwApprovalAuthorityModal({
  isOpen,
  onClose,
  onSuccess,
  authority,
}: CtwApprovalAuthorityModalProps) {
    ...
    if (isOpen) {
      ...
      if (authority) {
        setFormData({
          ...
          is_semester_forward: authority.is_semester_forward,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authority) {
        await ctwApprovalService.updateAuthority(authority.id, data);
      } else {
        await ctwApprovalService.storeAuthority(data);
      }
      onSuccess();
      onClose();
    } catch (err) {
      ...
      <div className="p-6">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-900 uppercase text-center">
            {authority ? "Edit CTW Authority" : "Add CTW Approval Authority"}
          </h2>
          <p className="text-sm text-gray-500 text-center">
            Define roles and permissions for CTW result approval processes.
          </p>
        </div>
              ...
              <div className="pt-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    { key: "is_semester_forward", label: "Semester Forward" },
