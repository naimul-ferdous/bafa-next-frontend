...
export default function DtAssessmentResultForm({ initialData, onSubmit, onCancel, loading, isEdit = false }: ResultFormProps) {
  const { user } = useAuth();
        ...
        <div className="border border-gray-200 rounded-lg p-6">
          ...
          {!filtersSelected ? (
            ...
            <div className="text-center py-12 text-red-500">
              ...
              <p className="font-medium">You are not assigned to the DT Assessment Observation module for the selected course & semester.</p>
            </div>
          ) : cadetRows.length === 0 ? (
            <div className="text-center py-12 text-gray-500">
              ...
              <table className="w-full border-collapse border border-black text-sm">
                <thead>
                  <tr>
                    ...
                    <th className="border border-black px-3 py-2 text-center">Conv</th>
                    <th className="border border-black px-3 py-2 text-center" rowSpan={2}>Total</th>
                  </tr>
                  <tr>
                    <th className="border border-black px-3 py-2 text-center">{maxMark > 0 ? maxMark : "N/A"}</th>
                    <th className="border border-black px-3 py-2 text-center">{convMark > 0 ? convMark : 'N/A'}</th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    <tr key={cadet.cadet_id} className="hover:bg-gray-50">
                      ...
                      <td className="border border-black px-2 py-1 text-center">
                        <input
                          ...
                          className="w-full px-2 py-1 border border-gray-300 rounded text-center text-sm focus:ring-2 focus:ring-blue-500 bg-white text-gray-900"
                        />
                      </td>
                      <td className="border border-black px-3 py-2 text-center font-bold">
                        {maxMark > 0 ? ((cadet.mark / maxMark) * convMark).toFixed(2) : "N/A"}
                      </td>
