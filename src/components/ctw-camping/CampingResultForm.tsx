...
interface ResultFormProps {
  initialData?: CtwDrillResult | null;
...
export default function CampingResultForm({ initialData, onSubmit, onCancel, loading, isEdit = false }: ResultFormProps) {
  ...
  // Load dropdown data + find camping module
  useEffect(() => {
  ...
  const getMaxMark = (): number => {
    ...
    return parseFloat(em?.estimated_mark_per_instructor || em?.mark || 0);
  };
  ...
  useEffect(() => {
    const loadCadets = async () => {
      ...
      try {
        ...
        // First check if instructor is assigned to this camping module
        ...
        <div className="border border-gray-200 rounded-lg p-6">
          ...
          {!filtersSelected ? (
            ...
            <div className="text-center py-12 text-red-500">
              ...
              <p className="font-medium">You are not assigned to the Camping module for the selected course & semester.</p>
