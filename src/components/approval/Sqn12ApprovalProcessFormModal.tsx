...
export default function Sqn12ApprovalProcessFormModal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingProcess) {
        await ftw12sqnFlyingExamApprovalProcessService.update(editingProcess.id, submitData);
      } else {
        await ftw12sqnFlyingExamApprovalProcessService.create(submitData);
      }
