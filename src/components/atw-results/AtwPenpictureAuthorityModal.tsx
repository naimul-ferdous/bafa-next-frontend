...
interface Props {
  ...
  onClose: () => void;
  onSuccess: () => void;
  authority: AtwPenpictureAuthority | null;
}

export default function AtwPenpictureAuthorityModal({ isOpen, onClose, onSuccess, authority }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authority) {
        await atwPenpictureAuthorityService.update(authority.id, data);
      } else {
        await atwPenpictureAuthorityService.store(data);
      }
      onSuccess();
      onClose();
    } catch {
