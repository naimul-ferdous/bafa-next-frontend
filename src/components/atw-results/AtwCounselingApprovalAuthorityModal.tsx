...
interface Props {
  ...
  onClose: () => void;
  onSuccess: () => void;
  authority: AtwCounselingApprovalAuthority | null;
}

export default function AtwCounselingApprovalAuthorityModal({ isOpen, onClose, onSuccess, authority }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authority) {
        await atwCounselingApprovalAuthorityService.update(authority.id, data);
      } else {
        await atwCounselingApprovalAuthorityService.store(data);
      }
      onSuccess();
      onClose();
    } catch {
