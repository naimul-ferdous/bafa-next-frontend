...
interface Props {
  ...
  onClose: () => void;
  onSuccess: () => void;
  authority: AtwOlqApprovalAuthority | null;
}

export default function AtwOlqApprovalAuthorityModal({ isOpen, onClose, onSuccess, authority }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authority) {
        await atwOlqApprovalAuthorityService.update(authority.id, data);
      } else {
        await atwOlqApprovalAuthorityService.store(data);
      }
      onSuccess();
      onClose();
    } catch {
