...
interface CommandTypeFormProps {
  initialData?: Ftw11SqnAssessmentCommandType | null;
  onSubmit: (data: Ftw11SqnAssessmentCommandTypeCreateData) => Promise<void>;
  onCancel: () => void;
  loading: boolean;
  isEdit?: boolean;
}
...
export default function CommandTypeForm({ initialData, onSubmit, onCancel, loading, isEdit = false }: CommandTypeFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submitData: Ftw11SqnAssessmentCommandTypeCreateData = {
