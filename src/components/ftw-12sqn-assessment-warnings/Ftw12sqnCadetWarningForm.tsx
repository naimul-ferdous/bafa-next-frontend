...
interface Ftw12sqnCadetWarningFormProps {
...
export default function Ftw12sqnCadetWarningForm({ initialData, onSubmit, onCancel, loading, isEdit = false }: Ftw12sqnCadetWarningFormProps) {
  const { user } = useAuth();
