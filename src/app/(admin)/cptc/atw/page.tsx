...
function CptcATWConsolidatedContent() {
  ...
  const handleViewResults = (course: SystemCourse) => {
    router.push(`/cptc/consolidated/course/${course.id}/atw`);
  };
...
export default function CptcATWConsolidatedPage() {
  return (
    <CourseModalProvider>
      <CptcATWConsolidatedContent />
    </CourseModalProvider>
  );
}
