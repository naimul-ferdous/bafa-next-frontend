...
export default function AtwApprovalAuthoritiesPage() {
  ...
  const [statusAuthority, setStatusAuthority] = useState<AtwResultApprovalAuthority | null>(null);
  ...
  const loadAuthorities = useCallback(async () => {
    try {
      ...
      if (response.data && Array.isArray(response.data)) {
        ...
        const arr = response as unknown as AtwResultApprovalAuthority[];
        setAuthorities(arr);
  ...
  const handleToggleStatus = (authority: AtwResultApprovalAuthority) => {
  ...
  const confirmToggleStatus = async () => {
    ...
    try {
      ...
      await atwApprovalService.updateAuthority(statusAuthority.id, {
