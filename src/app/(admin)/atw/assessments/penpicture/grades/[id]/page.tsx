...
export default function GradeDetailsPage() {
  ...
  useEffect(() => {
    const loadGrade = async () => {
      try {
        setLoading(true);
        const data = await atwAssessmentPenpictureGradeService.getGrade(parseInt(gradeId));
        if (data) {
          setGrade(data);
        } else {
    ...
    return (
      <div className="bg-white p-6 rounded-lg border border-gray-200">
        <div className="text-center py-12">
          ...
          <button
            onClick={() => router.push("/atw/assessments/penpicture/grades")}
    ...
    <div className="print-no-border bg-white rounded-lg border border-gray-200">
      ...
      <div className="p-4 flex items-center justify-between no-print">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() => router.push(`/atw/assessments/penpicture/grades/${grade.id}/edit`)}
