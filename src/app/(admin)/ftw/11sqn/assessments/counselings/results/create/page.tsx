...
export default function CreateResultPage() {
  ...
  const handleSubmit = async (data: any) => {
    setLoading(true);
    try {
      await ftw11sqnAssessmentCounselingResultService.createResult(data);
  ...
  return (
    <div className="bg-white p-6 rounded-lg border border-gray-200">
      <div className="text-center mb-8">
        ...
        <h2 className="text-md font-semibold text-gray-700 mt-2 uppercase">Add FTW 11sqn Assessment Counseling Results</h2>
      </div>
