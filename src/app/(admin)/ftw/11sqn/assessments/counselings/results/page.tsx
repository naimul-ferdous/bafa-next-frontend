...
export default function Ftw11SqnViewAssessmentCounselingResultsPage() {
  ...
  const loadData = useCallback(async () => {
    try {
      setLoading(true);
      const response = await ftw11sqnAssessmentCounselingResultService.getGroupedResults({
        page: currentPage,
        per_page: perPage,
      ...
      render: (row) => {
        ...
        return (
          <div className="flex items-center justify-center gap-1">
            {can("view") && (
              <button
                onClick={(e) => { e.stopPropagation(); router.push(`/ftw/11sqn/assessments/counselings/results/course/${row.course_id}/semester/${row.semester_id}`); }}
  ...
  return (
    <div className="bg-white p-6 rounded-lg border border-gray-200 space-y-6">
      <div className="text-center mb-8">
        ...
        <h2 className="text-md font-semibold text-gray-700 mt-2 uppercase tracking-widest">FTW 11SQN Counseling Assessment Results</h2>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-3">
          {can("add") && hasCounselingAssign && (
            <button
              onClick={() => router.push("/ftw/11sqn/assessments/counselings/results/create")}
      ...
      {loading ? (
        ...
        <>
          <DataTable
            ...
            onRowClick={(row) => router.push(`/ftw/11sqn/assessments/counselings/results/course/${row.course_id}/semester/${row.semester_id}`)}
          />
