...
export default function Ftw11sqnCadetWarningDetailsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    <div className="print-no-border bg-white rounded-lg border border-gray-200">
      ...
      <div className="p-4 flex items-center justify-between no-print">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() => router.push(`/ftw/11sqn/assessments/warnings/${warning.id}/edit`)}
      ...
      <div className="p-8 cv-content">
        ...
        <div className="mb-8">
          ...
          <p className="text-center font-medium text-gray-900 uppercase tracking-wider pb-2">
            Cadet Warning Detail Report (11SQN)
          </p>
        </div>
