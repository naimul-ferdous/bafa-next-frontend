...
function ApprovalProcessPageContent() {
  ...
  const loadProcesses = useCallback(async () => {
    try {
      setLoading(true);
      const response = await ftw11sqnFlyingExamApprovalProcessService.getAll({
        page: currentPage,
        per_page: perPage,
      });
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      await ftw11sqnFlyingExamApprovalProcessService.delete(deletingProcess.id);
      await loadProcesses();
    ...
    <div className="bg-white p-6 rounded-lg border border-gray-200 space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="text-md font-semibold text-gray-700 mt-2 uppercase">
          FTW 11SQN Flying Examination - Approval Process Management
        </h2>
