...
export default function Ftw11sqnFlyingEndingReportPage() {
  ...
  return (
    <div className="bg-white p-6 rounded-lg border border-gray-200 space-y-6">
      <div className="text-center mb-8">
        ...
        <h2 className="text-md font-semibold text-gray-700 mt-2 uppercase">FTW 11SQN Flying Examination Ending Report</h2>
      </div>
