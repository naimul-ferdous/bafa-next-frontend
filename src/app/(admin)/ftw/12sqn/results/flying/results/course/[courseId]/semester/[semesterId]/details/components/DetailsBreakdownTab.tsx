...
const DetailsBreakdownTab: React.FC<DetailsBreakdownTabProps> = ({
  ...
  // Convert flight time where decimal represents minutes (7.55 = 7h 55m)
  const convertToFlightTime = (timeValue: number): number => {
                ...
                <React.Fragment key={cadet.cadet_details.id}>
                  ...
                  <tr>
                    ...
                    >
                      ...
                      {cadet.cadet_details?.rank?.name || "N/A"}
                    </td>
                  </tr>
                  ...
                  {cadet.phases.map((phase, phaseIndex) => {
                    return (
                  ...
                  {(() => {
                    ...
                    const grandTotalMarks = validMarks.reduce((sum, mark) => sum + mark, 0);
