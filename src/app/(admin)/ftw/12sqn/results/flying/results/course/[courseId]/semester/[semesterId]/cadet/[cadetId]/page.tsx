...
interface PhaseData {
    ...
    exercises: Ftw12sqnFlyingExaminationMark[];
}
...
export default function FlyingExamination12SqnCadetView() {
    ...
    const fetchCadetData = useCallback(async () => {
        ...
        try {
            ...
            response.data.forEach((mark) => {
                const phaseId = mark.ftw_12sqn_flying_syllabus_id;
    ...
    const fetchApprovalData = useCallback(async () => {
        ...
        try {
            ...
            const processResult = await ftw12sqnFlyingExamApprovalProcessService.getAll({ allData: true });
            ...
            const statusResult = await ftw12sqnFlyingExamCadetApprovalStatusService.getByCadet(parseInt(cadetId), {
                course_id: parseInt(courseId),
                semester_id: parseInt(semesterId),
                allData: true,
            });
