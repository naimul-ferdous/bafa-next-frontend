...
export default function Ftw12sqnFlyingExaminationMarksPage() {
  ...
  const handleAddMark = () => router.push("/ftw/12sqn/results/flying/results/create");
  ...
  const handleViewDetails = (row: SemesterRow) => {
    ...
    router.push(`/ftw/12sqn/results/flying/results/course/${row.course_id}/semester/${row.semester_id}`);
  };
