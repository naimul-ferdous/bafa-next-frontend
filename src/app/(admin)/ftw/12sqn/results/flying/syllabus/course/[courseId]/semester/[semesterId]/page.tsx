...
export default function Ftw12sqnDetailedFlyingSyllabusPage() {
    ...
    const loadSyllabus = useCallback(async () => {
        try {
            setLoading(true);
            // Fetch course grouped data and filter for this specific course/semester
            const data = await ftw12sqnFlyingSyllabusService.getCourseGrouped({ course_id: courseId, include_inactive: true });
                ...
                <div className="flex items-center gap-4 mb-6">
                    <div className="flex-1 text-center">
                        ...
                        <h2 className="text-md font-semibold text-gray-700 mt-2 uppercase">
                            FTW 12 SQN Flying Syllabus - {courseName} ({semesterName})
                        </h2>
                    </div>
                </div>
                                ...
                                {tableData.length === 0 ? (
                                    ...
                                    tableData.map((row, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-2 text-gray-900 border-r border-black uppercase font-bold">
                                                {row.phase_full_name}
                                            </td>
                                            ...
                                            <td className="px-3 py-2 text-center font-bold text-gray-900 border-r border-black">
                                                {row.total_sorties}
                                            </td>
                                            <td className="px-3 py-2 text-center font-bold text-green-700 border-r border-black font-mono">
