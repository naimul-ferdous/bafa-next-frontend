...
interface PhaseData {
    ...
    exercises: Ftw12sqnGroundExaminationMark[];
}
...
export default function GroundExamination12SqnCadetView() {
    ...
    const handleBack = () => {
        router.push(`/ftw/12sqn/results/ground/results/course/${courseId}/semester/${semesterId}`);
    };
    ...
    const handleEditMark = (mark: Ftw12sqnGroundExaminationMark) => {
        router.push(`/ftw/12sqn/results/ground/results/${mark.id}/edit`);
    };
