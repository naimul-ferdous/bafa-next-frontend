...
export default function Ftw12sqnGroundExaminationMarksCadetPage () {
    ...
    const fetchGroundSyllabuses = async () => {
        try {
            const result = await ftwGroundSyllabus12SqnApi.getAll();
    ...
    const fetchCadetData = async (cadetId, appliedFilters = {}) => {
        ...
        setError(null);
        try {
            const response = await groundExamination12SqnApi.getByCadetId(cadetId, appliedFilters);
    ...
    const handleSaveExamination = async (data) => {
        ...
        setEditLoading(true);
        try {
            await groundExamination12SqnApi.update(selectedExamination.id, data);
    ...
    const handleDeleteExamination = async () => {
        ...
        try {
            await groundExamination12SqnApi.delete(selectedExaminationId);
        ...
        <div className="mx-auto p-6 bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="relative pb-0">
                <div className="text-center flex flex-col justify-between items-center bg-transparent p-4">
                    ...
                    <h2 className="text-lg font-bold text-gray-800 uppercase underline">12Sqn Baf</h2>
                </div>
