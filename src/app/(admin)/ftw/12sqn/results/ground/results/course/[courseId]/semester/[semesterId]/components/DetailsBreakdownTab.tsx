...
interface DetailsBreakdownTabProps {
  ...
  onEdit?: (mark: Ftw12sqnGroundExaminationMark) => void;
  onDelete?: (mark: Ftw12sqnGroundExaminationMark) => void;
}
  ...
  const transformedCadets = semesterData.cadets.map((cadet) => {
    const phases: {
      [key: number]: {
        ...
        exercises: (Ftw12sqnGroundExaminationMark & { cadet_details: typeof cadet.cadet_details })[];
      };
    } = {};
