...
import type { Ftw12SqnAssessmentCounselingType } from "@/libs/types/ftw12sqnAssessmentCounseling";
    ...
    return (
      <div className="bg-white p-6 rounded-lg border border-gray-200">
        <div className="text-center py-12">
          ...
          <button
            onClick={() => router.push("/ftw12sqn/assessments/counselings/events")}
    ...
    <div className="print-no-border bg-white rounded-lg border border-gray-200">
      ...
      <div className="p-4 flex items-center justify-between no-print">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() => router.push(`/ftw12sqn/assessments/counselings/events/${type.id}/edit`)}
