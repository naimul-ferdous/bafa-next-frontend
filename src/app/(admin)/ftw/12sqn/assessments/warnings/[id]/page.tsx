...
export default function Ftw12sqnCadetWarningDetailsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    <div className="print-no-border bg-white rounded-lg border border-gray-200">
      ...
      <div className="p-4 flex items-center justify-between no-print">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() => router.push(`/ftw/12sqn/assessments/warnings/${warning.id}/edit`)}
      ...
      <div className="p-8 cv-content">
        ...
        <div className="mb-8">
          ...
          <p className="text-center font-medium text-gray-900 uppercase tracking-wider pb-2">
            Cadet Warning Detail Report (12SQN)
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-3">
            ...
            <div className="flex">
              ...
              <span className="mr-4">:</span>
              <span className="text-gray-900 flex-1 font-mono font-bold">{warning.cadet?.bd_no || warning.cadet?.bdno || warning.cadet?.cadet_number || "N/A"}</span>
            </div>
            <div className="flex">
              <span className="w-48 text-gray-900 font-medium">Rank</span>
              <span className="mr-4">:</span>
              <span className="text-gray-900 flex-1">{(warning.cadet as any)?.rank?.name || "Cadet"}</span>
            </div>
            <div className="flex">
              <span className="w-48 text-gray-900 font-medium">Flight / Wing</span>
              <span className="mr-4">:</span>
              <span className="text-gray-900 flex-1">{(warning.cadet as any)?.flight?.name || "N/A"}</span>
            </div>
          </div>
        </div>
