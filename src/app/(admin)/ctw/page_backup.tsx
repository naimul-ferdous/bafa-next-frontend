...
const demoNotices: NoticeItem[] = [
  {
    id: 1,
    title: "Foot Drill Assessment Tomorrow",
    body: "All cadets must report to the parade ground at 0700 hrs for the scheduled foot drill evaluation. Dress: No. 1 uniform.",
    timestamp: "10 mins ago",
    tag: "Urgent",
    tagColor: "bg-red-100 text-red-600",
    icon: "hugeicons:running",
    iconBg: "from-orange-500 to-red-600",
    isNew: true,
  },
  {
    id: 2,
    title: "Sword Drill Results Published",
    body: "Term-II sword drill results are now available under the Sword Drill module. Verify scores before consolidation.",
    timestamp: "2 hrs ago",
    tag: "Sword Drill",
  ...
  {
    id: 3,
    title: "Leadership Marks Pending",
    body: "Course instructors are reminded to submit leadership skill marks for all cadets by end of week.",
    timestamp: "4 hrs ago",
    tag: "Leadership",
  ...
  {
    id: 4,
    title: "Arms Drill Schedule Updated",
    body: "The arms drill timetable has been revised. Please check the updated schedule in the Arms Drill module.",
    timestamp: "Yesterday",
    tag: "Arms Drill",
  ...
  {
    id: 5,
    title: "OLQ Counseling Records Due",
    body: "OLQ counseling entries for the current term must be submitted to the CTW admin before consolidation.",
    ...
    <div className="relative bg-white rounded-[1.5rem] sm:rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto divide-y divide-slate-50 px-1.5 sm:px-2 py-1.5 sm:py-2">
        {demoNotices.map((notice) => (
          ...
          >
            {notice.isNew && (
              <span className="absolute top-3 sm:top-4 right-3 sm:right-4 w-2 h-2 rounded-full bg-emerald-500" />
            )}
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] sm:text-xs font-black text-slate-800 leading-snug group-hover:text-emerald-700 transition-colors">
                {notice.title}
              </p>
      ...
      <div className="px-4 sm:px-6 py-3 sm:py-4 border-t border-slate-100">
        <Link
          href="/notices"
          className="group flex items-center justify-center gap-2 w-full py-2 sm:py-2.5 rounded-xl bg-slate-50 hover:bg-emerald-50 border border-slate-100 hover:border-emerald-200 transition-all duration-300"
        >
          <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-slate-500 group-hover:text-emerald-600 transition-colors">
            View All Notices
          </span>
          <Icon icon="hugeicons:arrow-right-02" className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-slate-400 group-hover:text-emerald-500 transition-colors" />
        </Link>
      </div>
    </div>
  );
