...
import type { CtwAssessmentOlqResult, CtwAssessmentOlqResultCreateData } from "@/libs/types/ctwAssessmentOlq";
  ...
  useEffect(() => {
    const loadResult = async () => {
      try {
        ...
        const resultData = await ctwAssessmentOlqResultService.getResult(parseInt(resultId));
        if (resultData) {
