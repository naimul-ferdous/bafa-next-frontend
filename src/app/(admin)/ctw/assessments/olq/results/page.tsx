...
export default function CtwAssessmentOlqResultsPage() {
  ...
  useEffect(() => {
    ...
    ctwUserAssignService.getAll({ user_id: instructorId })
      .then((data) => {
        setHasOlqAssignment(data.olq.length > 0);
      })
      .catch((err) => {
        console.error("Failed to fetch CTW OLQ assignments:", err);
  ...
  const dynamicNodes = [
    { 
      title: "Input Result", 
      href: canInput ? "/ctw/assessments/olq/results/create" : undefined, 
      icon: "hugeicons:pencil-edit-01",
      onClick: canInput ? undefined : handleInputResultClick
    },
    { title: "View Result", href: "/ctw/assessments/olq/results/view", icon: "hugeicons:notebook" },
  ];
          ...
          <div className="flex items-center justify-center overflow-hidden relative">
            ...
            <div className="sm:hidden w-full space-y-5 py-4">
              <div className="text-center relative py-8 rounded-2xl overflow-hidden">
                ...
                <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mt-2">CTW Result Management</p>
              </div>
        ...
        <div className="flex flex-col gap-4 text-center">
          ...
          <div className="mt-2">
            ...
            <p className="text-sm text-gray-600 mt-3">
              You are not Eligible for Input Mark. Please contact admin to assign you to a CTW OLQ assessment for a course.
            </p>
          </div>
