...
const StatCard = ({ label, value, icon, bgImage, loading }: StatCardProps) => (
...
const nodes = [
  { title: "Input Punishment", href: "/ctw/assessments/warnings/create", icon: "hugeicons:pencil-edit-01" },
  { title: "View Punishments", href: "/ctw/assessments/warnings/view",   icon: "hugeicons:notebook" },
];
    ...
    <div className="flex flex-col items-center gap-6 animate-in fade-in duration-700">
      ...
      <div className="sm:hidden w-full space-y-5 py-4 px-3">
        <div className="text-center relative py-8 rounded-2xl overflow-hidden">
          ...
          <h1 className="text-4xl font-black text-slate-900">PUNISHMENTS</h1>
          <div className="h-1.5 w-16 bg-blue-600 rounded-full mt-2 mx-auto" />
          <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mt-2">CTW Punishment Management</p>
        </div>
