...
export default function GskCourseSemesterResultPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const data = await ctwGskResultService.getInitialFetchData({
        ...
        <div className="mb-8">
          ...
          <div className="mb-2">
            ...
            <p className="text-center font-medium text-gray-900 uppercase underline tracking-wider">
              {courseDetails?.name} ({moduleDetails?.full_name || "GSK"})
            </p>
            <p className="text-center font-medium text-gray-900 uppercase underline tracking-wider">
