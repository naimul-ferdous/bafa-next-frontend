...
export default function GstoAssessmentCourseSemesterResultPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const data = await ctwGstoAssessmentResultService.getInitialFetchData({
    ...
    <div className="print-no-border bg-white rounded-lg border border-gray-200">
      ...
      <div className="p-8 cv-content">
        <div className="mb-8 text-center">
          ...
          <p className="font-medium text-gray-900 uppercase tracking-wider pb-2">CTW {moduleDetails?.full_name || "GSTO Assessment"} Course Result Sheet</p>
        </div>
