              ...
              <tbody>
                {rankedData.map((item, index) => (
                  <tr key={item.cadet.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="border border-black px-2 py-2 font-bold uppercase text-blue-600">{item.cadet?.name || "N/A"}</td>
                    ...
                    <td className="border border-black px-2 py-2 text-center font-black text-emerald-700 bg-emerald-50/20">{isComplete ? item.convertedMark.toFixed(2) : "-"}</td>
                    <td className="border border-black px-2 py-2 text-center font-bold text-blue-700 bg-blue-50/20">{isComplete ? getOrdinal(item.position) : "-"}</td>
                    <td className={`border border-black px-2 py-2 text-center font-medium ${item.remark === "Failed" ? "text-red-600 bg-red-50/20" : "text-gray-400"}`}>{item.remark}</td>
                  </tr>
                ))}
              </tbody>
            </table>
