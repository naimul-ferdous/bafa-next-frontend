                    ...
                    return (
                      <tr key={mark.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="border border-black px-2 py-2">
                          <button onClick={() => router.push(`/ctw/results/assessment_observation/dt/cadet/${mark.cadet_id}`)} className="text-blue-600 font-bold uppercase hover:underline hover:text-blue-800 text-left">
                            {mark.cadet?.name || "N/A"}
                          </button>
                        </td>
      ...
      <Modal isOpen={approvalModal.open} onClose={() => setApprovalModal(prev => ({ ...prev, open: false }))} showCloseButton className="max-w-lg">
        <div className="p-6">
          <div className="text-center mb-4">
            ...
            <p className="text-sm font-medium text-gray-700 uppercase">CTW DT Assessment</p>
          </div>
          <h2 className="text-lg font-bold text-gray-900 mb-1">
            {approvalModal.cadetIds.length === 1 ? "Cadet Approval" : `Cadets Approval (${approvalModal.cadetIds.length} cadets)`}
          </h2>
          <p className="text-sm text-gray-500 mb-4">Module: <span className="font-medium text-gray-700">DT Assessment</span></p>
