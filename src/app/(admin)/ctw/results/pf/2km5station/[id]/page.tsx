...
export default function TwoKmFiveStationResultDetailsPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      setLoading(true);
      const data = await ctwOneMileResultService.getResult(twoKmModuleId, parseInt(resultId));
      if (data) {
    ...
    return (
      <div className="bg-white p-6 rounded-lg border border-gray-200">
        <div className="text-center py-12">
          ...
          <button
            onClick={() => router.push("/ctw/results/pf/2km5station")}
      ...
      <div className="p-8 cv-content">
        <div className="mb-8">
          ...
          <p className="text-center font-medium text-gray-900 uppercase tracking-wider pb-2">
            CTW 2KM 5 Station Result Sheet
          </p>
        </div>
      ...
      >
        <div className="p-6">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Module: <span className="font-medium text-gray-700">2KM 5 Station</span>
          </p>
