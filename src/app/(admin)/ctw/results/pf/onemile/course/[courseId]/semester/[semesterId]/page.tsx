    ...
    return (
      <div className="bg-white p-6 rounded-lg border border-gray-200">
        <div className="text-center py-12">
          ...
          <button onClick={() => router.push("/ctw/results/pf/onemile")} className="mt-4 px-6 py-2 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-all font-bold">
            Back to Results
          </button>
        </div>
      </div>
  ...
  return (
    <div className="print-no-border bg-white rounded-lg border border-gray-200">
      <style jsx global>{`
        @media print {
          ...
          .signature-box .sig-label {
            font-size: 10px !important; font-weight: 700 !important; color: #111827 !important;
      ...
      <div className="p-4 flex items-center justify-between no-print">
        <button onClick={() => router.push("/ctw/results/pf/onemile")} className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 flex items-center gap-2 font-medium transition-all">
        ...
        <div className="mb-8">
          ...
          <div className="mb-2">
            ...
            <p className="text-center font-medium text-gray-900 uppercase underline tracking-wider">
              {courseDetails?.name} ({moduleDetails?.full_name || "One Mile"})
            </p>
            <p className="text-center font-medium text-gray-900 uppercase underline tracking-wider">
                ...
                <tr>
                  ...
                  {instructorSlots.map(i => (
                    <React.Fragment key={i}>
                      ...
                      <th rowSpan={hasPractices ? 2 : 1} className="border border-black px-2 py-1 text-center align-middle whitespace-nowrap text-xs font-semibold">Prac<br />({estimatedMark?.convert_of_practice || 0}%)</th>
                      <th rowSpan={hasPractices ? 2 : 1} className="border border-black px-2 py-1 text-center align-middle whitespace-nowrap text-xs font-semibold">Exam<br />({estimatedMark?.convert_of_exam || 0}%)</th>
      ...
      <Modal isOpen={approvalModal.open} onClose={() => setApprovalModal(prev => ({ ...prev, open: false }))} showCloseButton className="max-w-lg">
        <div className="p-6">
          <div className="text-center mb-4">
            ...
            <p className="text-sm font-medium text-gray-700 uppercase">CTW One Mile</p>
          </div>
