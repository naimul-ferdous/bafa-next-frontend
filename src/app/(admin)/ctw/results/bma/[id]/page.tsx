                            ...
                            <table className="w-full border-collapse border border-black text-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="border border-black px-2 py-2 text-center">Instructor</th>
                                ...
                                <tbody>
                                    {result.achieved_marks.map((mark, index) => (
                                        <tr key={mark.id}>
                                            ...
                                            <td className="border border-black px-2 py-2 text-blue-600 font-medium">{(mark.cadet as any)?.name || "N/A"}</td>
