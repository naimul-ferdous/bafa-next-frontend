...
export default function BmaCourseSemesterResultPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const data = await ctwBmaResultService.getInitialFetchData({
        module_code: BMA_MODULE_CODE,
        course_id: courseId,
    ...
    return (
      <div className="bg-white p-6 rounded-lg border border-gray-200">
        <div className="text-center py-12">
          ...
          <button
            onClick={() => router.push("/ctw/results/bma")}
      ...
      <div className="p-8 cv-content">
        <div className="mb-8">
          ...
          <div className="mb-2">
            ...
            <p className="text-center font-medium text-gray-900 uppercase underline tracking-wider">
              {courseDetails?.name} ({moduleDetails?.full_name || "BMA"})
            </p>
            <p className="text-center font-medium text-gray-900 uppercase underline tracking-wider">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-3">
            ...
            <div className="flex">
              <span className="w-48 text-gray-900 font-medium">Weightage (per inst)</span>
              <span className="mr-4">:</span>
              <span className="text-gray-900 flex-1 font-bold">{estimatedMarkPerInstructor}</span>
            </div>
            <div className="flex">
