...
export default function LeadershipSkillResultDetailsPage() {
  ...
  const loadData = useCallback(async () => {
    if (leadershipSkillModuleId === null || resultId === undefined) return;
    try {
      setLoading(true);
      const data = await ctwLeadershipSkillResultService.getResult(leadershipSkillModuleId, parseInt(resultId));
      if (data) {
  ...
  }, [resultId, leadershipSkillModuleId]);
  ...
  }, [result, leadershipSkillModuleId]);
  ...
  const handleConfirmResubmit = async () => {
    ...
    if (!item || !leadershipSkillModuleId) return;
      ...
      <div className="p-8 cv-content">
        <div className="mb-8">
          ...
          <p className="text-center font-medium text-gray-900 uppercase tracking-wider pb-2">
            CTW Leadership Skill Result Sheet
          </p>
        </div>
      ...
      >
        <div className="p-6">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Module: <span className="font-medium text-gray-700">Leadership Skill</span>
          </p>
